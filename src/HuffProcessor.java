// Daniel Kingsbury & Karly Pearson
/**
...
public class HuffProcessor {
	...
	private void writeCompressedBits(String[] codings, BitInputStream in, BitOutputStream out) {
		while(true) {
		int k=in.readBits(BITS_PER_WORD);
		if (k==-1) break;
	...
	private HuffNode makeTreeFromCounts(int[] freqs) {
		...
		for(int k=0; k<freqs.length; k++) {
			if (freqs[k] > 0) pq.add(new HuffNode(k,freqs[k],null,null));
		}
	...
	private static int[] readForCounts(BitInputStream in) {
